...
int main(int argc, char* argv[]) {
    ...
    for (int i = 1; i < argc; ++i) {
        ...
        if ((arg == "-h") || (arg == "--help")) {
            ...
            printf(" OPTIONS\n");
            printf("     `-a` <habitname>, `--add`\n");
            printf("         Adds a new habit\n");
            printf("     `-c` <habitname>, `--complete`\n");
            printf("         Marks a habit complete for today\n");
            printf("     `-d` <habitname>, `--d` (THIS FEATURE IS NOT CURRENTLY FUNCTIONAL)\n");
            printf("         Deletes a habit\n");
            printf("     `-l` <habitname>, `--list`\n");
            printf("         Draws a calendar for the given habit\n");
            printf("     `-g` <habitname>, `--gethabits`\n");
            printf("         Lists all habits\n");
            printf("     `-u` <habitname>, `--uncomplete` (THIS FEATURE IS NOT CURRENTLY FUNCTIONAL)\n");
            printf("        Marks a habit uncomplete for today\n");
            printf(" LEGEND\n");
            printf("     ◆ Task Completed (Previous Day)\n");
            printf("     \033[1;32m◆\033[0m Task Completed (Today)\n");
            printf("     ◇ Task Not Completed (Previous Day)\n");
            printf("     \033[1;32m◇\033[0m Task Not Completed (Today)\n");
